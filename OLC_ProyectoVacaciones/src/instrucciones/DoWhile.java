...
public class DoWhile extends Instruccion {
    ...
    private LinkedList<Instruccion> bloqueDoWhile;

    public DoWhile(Instruccion condicion, LinkedList<Instruccion> bloqueDoWhile, int linea, int columna) {
    ...
    public Object interpretar(Arbol arbol, tablaSimbolos tabla) {
        ...
        do {
            ...
            newTabla2.setNombre(tabla.getNombre() + ", DO While");
            for (Instruccion i : this.bloqueDoWhile) {
