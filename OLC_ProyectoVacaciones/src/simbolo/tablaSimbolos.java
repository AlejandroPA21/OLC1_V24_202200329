...
public class tablaSimbolos {
    ...
    public boolean setVariable(Simbolo sim){
        Simbolo busqueda = (Simbolo) this.tablaActual.get(sim.getId().toLowerCase());
        if(busqueda == null){
            this.tablaActual.put(sim.getId().toLowerCase(), sim);
            return true;
        }
